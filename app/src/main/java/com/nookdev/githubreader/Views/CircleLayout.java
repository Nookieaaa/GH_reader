...
public class CircleLayout extends ViewGroup {
    ...
    public CircleLayout(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mAngleOffset = a.getFloat(R.styleable.CircleLayout_angleOffset, 60f);
        ...
        for(int i=0; i<childs; i++) {
            ...
            switch (getResources().getConfiguration().orientation){
                case Configuration.ORIENTATION_PORTRAIT:{
                    switch (child.getId()) {
                        //corrections portrait
                        case R.id.circle_text_username_company:{
                        ...
                        case R.id.circle_button_save:{
                            x = (int) (radius * Math.cos(Math.toRadians(centerAngle))) + width / 2;
                            y = (int) (radius * Math.sin(Math.toRadians(centerAngle))*0.9) + height / 2;
                            break;
                        }
                        case R.id.circle_text_following:{
                            x = (int) (radius * Math.cos(Math.toRadians(centerAngle))*1.3) + width / 2;
                            y = (int) (radius * Math.sin(Math.toRadians(centerAngle))*0.8) + height / 2;
                            break;
                        }
                ...
                case Configuration.ORIENTATION_LANDSCAPE:{
                    switch (child.getId()) {
                        ...
                        case R.id.circle_text_username_company:{
                            x = (int) (radius * Math.cos(Math.toRadians(centerAngle))) + width / 2;
                            y = (int) ((radius * Math.sin(Math.toRadians(centerAngle))) * 0.7) + height / 2;
                            break;
                        }
                        case R.id.circle_button_save:{
                            x = (int) (radius * Math.cos(Math.toRadians(centerAngle))) + width / 2;
